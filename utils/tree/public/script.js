...
fillTree = function () {
  ...
  createTreeFromHTML(window.pageContent);
...
document.addEventListener('DOMContentLoaded', () => {
  console.log(window.pageContent);
  fillTree();
});
